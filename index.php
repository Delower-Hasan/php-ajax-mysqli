  ...
  <div class="container">
    <div class="col-md-8">
      <div class="row">
        ...
        <form  id="contactForm" action="sendMessage.php" method="POST" novalidate>
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <input type="text"  name="fname" id="name" class="form-control" placeholder="Name" required="required">
...
function warningOut(res){
        let wrOut = document.getElementById('message_view');
        setTimeout(()=>{
