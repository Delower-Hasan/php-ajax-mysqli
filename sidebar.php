      ...
      <div class="navbar-menu-wrapper d-flex align-items-center">
        ...
        <ul class="navbar-nav navbar-nav-right">
          ...
          <li class="nav-item dropdown">
            ...
            <div id="dp-menu" class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="messageDropdown">
      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" data-toggle="collapse" href="#logo-layouts" aria-expanded="false" aria-controls="page-layouts">
                <i class="icon-check menu-icon"></i>
                <span class="menu-title">Logos</span>
                <span class="badge badge-danger">1</span>
              </a>
              <div class="collapse" id="logo-layouts">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item d-none d-lg-block"> <a class="nav-link" href="addLogo.php">Add Logo</a></li>
                </ul>
              </div>
            </li>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="page-layouts">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item d-none d-lg-block"> <a class="nav-link" href="addHeader.php">Add Header</a></li>
                </ul>
              </div>
            </li>

            <li class="nav-item">
              <a class="nav-link" data-toggle="collapse" href="#about-layouts" aria-expanded="false" aria-controls="page-layouts">
                <i class="icon-check menu-icon"></i>
              ...
              <div class="collapse" id="about-layouts">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item d-none d-lg-block"> <a class="nav-link" href="add_about.php">Add About</a></li>
                  <li class="nav-item d-none d-lg-block"> <a class="nav-link" href="view_about.php">View About</a></li>
                </ul>
              </div>
            </li>
            <!-- Services  start-->
            <li class="nav-item">
              <a class="nav-link" data-toggle="collapse" href="#service-layouts" aria-expanded="false" aria-controls="page-layouts">
                <i class="icon-check menu-icon"></i>
                <span class="menu-title">Services</span>
                <span class="badge badge-danger">2</span>
              </a>
              <div class="collapse" id="service-layouts">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item d-none d-lg-block"> <a class="nav-link" href="add_services.php">Add Services</a></li>
            ...
            <!-- mail  start-->
            <li class="nav-item">
              <a class="nav-link" data-toggle="collapse" href="#mail-layouts" aria-expanded="false" aria-controls="page-layouts">
                <i class="icon-check menu-icon"></i>
              ...
              <div class="collapse" id="mail-layouts">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item d-none d-lg-block"> <a class="nav-link" href="view_mail.php">view mail</a></li>
